...
public abstract class BaseBizArticleCategory<M extends BaseBizArticleCategory<M>> extends Model<M> implements IBean {

	public void setPkArticleCategory(java.lang.Integer pkArticleCategory) {
		set("PK_ARTICLE_CATEGORY", pkArticleCategory);
	}

	public java.lang.Integer getPkArticleCategory() {
		return get("PK_ARTICLE_CATEGORY");
	}
